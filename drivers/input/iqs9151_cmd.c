...
static int cmd_stats(size_t argc, char **argv, iqs9151_cmd_out_t out, void *ctx) {
    ...
    cmd_out(out, ctx, "stats i2c_max_us=%u i2c_avg_us=%u reset_n=%u rdy_miss=%u end_err=%u",
            (unsigned int)stats.i2c_max_us, (unsigned int)stats.i2c_avg_us,
            (unsigned int)stats.show_reset_count, (unsigned int)stats.rdy_miss,
